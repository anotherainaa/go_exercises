...
// bucket structure
// is a linked list in each slot of the hash table array
type bucket struct {
	head *bucketNode
}
...
// insert will take in a key, create a node with the key and sert the node in the bucket
...
// delete will take in a akey and delete the node from the bucket
